...
function Mobilenav() {
  ...
  return (
    <div className={styles.Mobilenav}>
      <Link href="/" className={styles.navitem}>
        <svg width="75" height="32" viewBox="0 0 109 46" fill="none" xmlns="http://www.w3.org/2000/svg">
          <style>
            {`
  ...
  `}
      ...
      <div className={`${styles.burgermenu} ${isOpen ? styles.open : ""}`}>
        <svg className={styles.menuicon} onClick={handleToggle} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 29">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M32 5H0V0H32V5Z" fill={appliedTheme === "dark" ? "var(--n-100)" : "var(--n-700)"} />
          <path fill-rule="evenodd" clip-rule="evenodd" d="M32 17H0V12H32V17Z" fill={appliedTheme === "dark" ? "var(--n-100)" : "var(--n-700)"} />
          <path fill-rule="evenodd" clip-rule="evenodd" d="M32 29H0V24H32V29Z" fill={appliedTheme === "dark" ? "var(--n-100)" : "var(--n-700)"} />
        </svg>
        <div className={styles.menuoverlay} onClick={handleToggle}>
          <div className={`${styles.menucontainer} ${appliedTheme === "dark" ? styles.menucontainer_dark : ""}`}>
            <svg className={styles.closeicon} onClick={handleToggle} width="24" height="24" viewBox="0 0 28 27" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M23.5459 26.5815L0.918507 3.95411L4.45404 0.418579L27.0815 23.046L23.5459 26.5815Z" fill={appliedTheme === "dark" ? "var(--n-100)" : "var(--n-700)"} />
              <path fill-rule="evenodd" clip-rule="evenodd" d="M0.918531 23.046L23.5459 0.418568L27.0815 3.9541L4.45407 26.5815L0.918531 23.046Z" fill={appliedTheme === "dark" ? "var(--n-100)" : "var(--n-700)"} />
            </svg>
